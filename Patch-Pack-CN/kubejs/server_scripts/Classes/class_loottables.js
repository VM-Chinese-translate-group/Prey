...
const x_class_lootboxes = {
    ...
    guardian : [
        ...
        Item.of('irons_spellbooks:iron_spell_book', '{ISB_Spells:{data:[{id:"irons_spellbooks:divine_smite",index:0,level:4,locked:0b},{id:"irons_spellbooks:shield",index:1,level:8,locked:0b},{id:"irons_spellbooks:slow",index:2,level:4,locked:0b},{id:"irons_spellbooks:heal",index:3,level:7,locked:0b},{id:"irons_spellbooks:healing_circle",index:4,level:7,locked:0b},{id:"irons_spellbooks:gust",index:5,level:8,locked:0b}],maxSpells:6,mustEquip:1b,spellWheel:1b},RepairCost:3,display:{Name:\'{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"#FFFFFF","text":"守护者的魔法书"}\'}}').enchant('soulbound:soulbound', 1).enchant('minecraft:mending', 1),
    ...
    battlemage: [
        ...
        Item.of('irons_spellbooks:gold_spell_book', '{ISB_Spells:{data:[{id:"irons_spellbooks:earthquake",index:0,level:6,locked:0b},{id:"irons_spellbooks:lightning_lance",index:1,level:4,locked:0b},{id:"irons_spellbooks:electrocute",index:2,level:6,locked:0b},{id:"irons_spellbooks:icicle",index:3,level:6,locked:0b},{id:"irons_spellbooks:starfall",index:4,level:6,locked:0b},{id:"irons_spellbooks:burning_dash",index:5,level:7,locked:0b},{id:"irons_spellbooks:evasion",index:6,level:3,locked:0b},{id:"irons_spellbooks:spectral_hammer",index:7,level:4,locked:0b}],maxSpells:8,mustEquip:1b,spellWheel:1b},RepairCost:3,display:{Name:\'{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"#FFFFFF","text":"战斗法师的法典"}\'}}').enchant('soulbound:soulbound', 1).enchant('minecraft:mending', 1)
    ...
    conjurer: [
        ...
        Item.of('irons_spellbooks:blood_staff', '{RepairCost:3}').enchant('minecraft:mending', 1).enchant('soulbound:soulbound', 1),
        Item.of('irons_spellbooks:necronomicon_spell_book', '{ISBEnhance:"irons_spellbooks:raise_dead",ISB_Spells:{data:[{id:"irons_spellbooks:blood_slash",index:0,level:5,locked:1b},{id:"irons_spellbooks:blood_step",index:1,level:5,locked:1b},{id:"irons_spellbooks:ray_of_siphoning",index:2,level:5,locked:1b},{id:"irons_spellbooks:blaze_storm",index:3,level:5,locked:1b},{id:"irons_spellbooks:raise_dead",index:4,level:5,locked:0b},{id:"irons_spellbooks:summon_vex",index:5,level:3,locked:0b},{id:"irons_spellbooks:summon_polar_bear",index:6,level:6,locked:0b},{id:"irons_spellbooks:wisp",index:7,level:6,locked:0b}],maxSpells:10,mustEquip:1b,spellWheel:1b},RepairCost:3,display:{Name:\'{"bold":false,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false,"color":"#FFFFFF","text":"死亡图腾"}\'}}').enchant('soulbound:soulbound', 1).enchant('minecraft:mending', 1),
        ],
    ...
    spellsword:[
        Item.of('irons_spellbooks:copper_spell_book', '{ISB_Spells:{data:[{id:"irons_spellbooks:magma_bomb",index:0,level:5,locked:0b},{id:"irons_spellbooks:burning_dash",index:1,level:5,locked:0b},{id:"irons_spellbooks:wall_of_fire",index:2,level:3,locked:0b},{id:"irons_spellbooks:fire_breath",index:3,level:5,locked:0b},{id:"irons_spellbooks:flaming_strike",index:4,level:3,locked:0b}],maxSpells:5,mustEquip:1b,spellWheel:1b},RepairCost:0,display:{Name:\'{"text":"Solaris"}\'}}').enchant('soulbound:soulbound', 1).enchant('minecraft:mending', 1),
    ...
    spirit_caller:[
        ...
        Item.of('immersive_armors:warrior_chestplate', '{Damage:0}').enchant('soulbound:soulbound', 1).enchant('minecraft:mending', 1),
    ...
    explorer:[
        ...
        Item.of('alexsmobs:rocky_chestplate', '{Damage:0}').enchant('soulbound:soulbound', 1).enchant('mending', 1),
